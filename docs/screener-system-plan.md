...
|---|---|---|
| 1 Capture + dedupe | `Screener: Capture Call` `jQaCWO08lddHg9fN` (**still off**, go-live) → data table `screener_calls` `3WK4mrEYwvDeDUVO` | mock of the real payload stored (exec 122325); identical re-POST stopped at dedupe (exec 122339) |
