...
for (const [file, sdk] of [['Screener Classify Transcript.json', 'classifier'], ['Screener Capture Call.json', 'capture'],
    ['Screener Classifier Eval.json', 'eval'], ['Screener Compare Step.json', 'compare'], ['Screener Mark + Compare.json', 'mark'], ['Screener Write-back Retry.json', 'retry'], ['Screener Test Rig.json', 'testrig'], ['Screener Attempt Counter.json', 'counter'], ['Screener No Answer.json', 'noanswer'], ['Screener WAVV Disposition.json', 'disposition'], ['Screener Graduate.json', 'graduate'], ['Screener Graduate Sweep.json', 'gradsweep'], ['Screener Log Retry.json', 'logretry'], ['Screener Daily Sweep.json', 'dailysweep']])
