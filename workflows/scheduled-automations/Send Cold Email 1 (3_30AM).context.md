...
5. **Instantly: Add to Cold Email 1** — POST `/api/v2/leads` into the campaign.
6. **GHL: Set email_step_name** — PUT contact, writes `cold email 1`.
7. **Wait 2s** → back to **Loop (batch 10)**.
